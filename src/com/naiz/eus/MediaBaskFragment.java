...
public class MediaBaskFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// Set the MediaBaskViewPagerAdapter into ViewPager
		viewPager.setAdapter(new MediaBaskViewPagerAdapter(getChildFragmentManager()));
		return rootView;
	}
}