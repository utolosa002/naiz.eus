...
public class NaizFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// Set the NaizViewPagerAdapter into ViewPager
		viewPager.setAdapter(new NaizViewPagerAdapter(getChildFragmentManager()));
		return rootView;
	}
}